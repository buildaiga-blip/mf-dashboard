...
const SECTOR_THEMES = [
  {
    ...
    keywords: ["bank", "banking", "nbfc", "rbi", "credit growth", "hdfc", "icici", "sbi"],
  },
  {
    ...
    keywords: ["infrastructure", "capex", "cement", "construction", "railway", "roads", "larsen"],
  },
  {
    ...
    keywords: ["manufacturing", "pli", "defence", "electronics", "make in india", "semiconductor"],
  },
  {
    ...
    keywords: ["renewable", "solar", "green energy", "power grid", "energy transition", "wind power"],
  },
  {
    ...
    keywords: ["pharma", "healthcare", "hospital", "generic drugs", "pharmaceutical"],
  },
  {
    ...
    keywords: ["it services", "tcs", "infosys", "software", "ai spending", "cloud computing"],
  },
  {
    ...
    keywords: ["retail", "consumer spending", "e-commerce", "quick commerce", "rural demand"],
  },
  {
    ...
    keywords: ["auto", "automobile", "electric vehicle", "ev sales", "car sales", "two-wheeler"],
  },
  {
    ...
    keywords: ["real estate", "housing", "property market", "home loan", "realty"],
  },
  {
    ...
    keywords: ["insurance", "life insurance", "health insurance", "irdai", "financial inclusion"],
  },
];
